            ...
            case 'Win':
                return (
                    <ol>
                        ...
                        <li>
                            Enter <code>dir C:\Users\<em>your_username</em>\.ssh\id_rsa</code> to see if existing ssh keys are present
                        </li>
                        <li>
                            Check the directory listing to see if you already have a public SSH key. The filenames of public keys should be one of the following:
                            <ul>
            ...
            >
                ...
                >
                    ...
                    <ol>
                        ...
                        <li>
                            Paste the text below, substituting in your email address <br/>
                            <Paper
                                variant="outlined"
                        ...
                        <li>
                            At the prompt, type a secure passphrase.<br/>
                            <Paper
                                variant="outlined"
                                sx={{ margin: "4px 0", padding: "10px", display: 'inline-block' }}
                            >
